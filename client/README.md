...
ExampleApi - JavaScript client for example_api
...
To use the link you just defined in your project, switch to the directory you want to use your example_api from, and run:
